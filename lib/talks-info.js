...
module.exports = function talksInfo(lang) {
  ...
  let menu = {
    ...
    ru: [['Расписание'], ['Помощь'], ['Назад в главное меню']]
  }
  ...
  let next = confData[lang].schedule
    .filter(talk => {
      return moment(new Date()).add(3, 'hours').isBefore(talk.fullStartTime) && talk.type !== 'break'
    })
    .sort((a, b) => {
