...
module.exports = function conferenceInfo(lang) {
  ...
  if (lang === 'ru') {
    ...
    description = `Не следует путать HolyJS с конференциями по фронтенду — в России есть много таких. Однако до этого года не было ни одной конференции по самому популярному в мире (по версии GitHub и RedMonk) языку программирования — JavaScript, который чаще всего ассоциируется с фронтендом.\n\nМы это исправили — HolyJS Moscow станет уже второй масштабной конференцией по JavaScript в 2016 году. Более 400 JS-разработчиков под одной крышей соберутся для того, чтобы обсудить наболевшее с JavaScript-экспертами со всего мира.`
